<script>
	import img1 from '$lib/assets/services/MarketResearch-opt2.webp';
	import img2 from '$lib/assets/services/Branding-opt2.webp';
	import img3 from '$lib/assets/services/Advertising-opt2.webp';
