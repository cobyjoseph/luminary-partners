...
<div class="heightClass bg-base px-[6%]  ">
	<div class="flex justify-center ">
		<div class=" flex w-[28vw] flex-col gap-4 ">
			<img src={img1} alt="" class=" bg-contain" />
			<div class="h-[0.07rem] w-[30%] bg-textLight" />
			<div class="font-satoshi text-3xl font-thin text-bright ">Market research</div>
			<div class="font-satoshi font-thin text-textLight">
		...
		<div class=" mt-[2rem] flex w-[28vw] flex-col  gap-4">
			...
			<div class="h-[0.07rem] w-[30%] bg-textLight" />
			<div class="font-satoshi text-3xl font-thin text-bright ">Branding and design</div>
			<div class="font-satoshi font-thin text-textLight">
		...
		<div class=" mt-[4rem] flex w-[28vw] flex-col  gap-4">
			...
			<div class="h-[0.07rem] w-[30%] bg-textLight" />
			<div class="font-satoshi text-3xl font-thin text-bright ">Advertising and promotion</div>
			<div class="font-satoshi font-thin text-textLight">
